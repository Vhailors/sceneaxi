...
bridge exposes **10 actions**, **10 authoring operations**, and **3 legacy
...
| Desktop interaction table | New, Open, Save, Export Web, Undo, Redo, Play | **real** | All seven retain their behavior while their identity, label, schema version, and permission derive from the shared registry; menu, palette, button, and accelerator parity remains executable. | `apps/desktop-shell/src/interaction-commands.ts`; command interaction golden. |
