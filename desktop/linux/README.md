...
round trip for selected X/Y/Z translation, rotation, and scale plus the bounded
local-artifact add/remove operation, Reject and Undo, the saved composition's
