...
describe("desktop local bridge contract", () => {
  it("ships one versioned agent-tool registry beside its JSON Schema", () => {
    ...
    expect(DESKTOP_LOCAL_BRIDGE_TOOLS.map((tool) => tool.name)).toEqual([
      ...
      "sceneaxi.environment.inspect",
      "sceneaxi.environment.apply",
      "sceneaxi.material.inspect",
      "sceneaxi.material.apply",
      "sceneaxi.effect.inspect",
      "sceneaxi.effect.apply",
      "sceneaxi.package.inspect",
      "sceneaxi.package.install",
      "sceneaxi.package.remove",
      "sceneaxi.profile.inspect",
      "sceneaxi.workspace.layout.inspect",
      "sceneaxi.workspace.layout.apply",
      "sceneaxi.workspace.layout.reset",
      "sceneaxi.extension.inspect",
      "sceneaxi.extension.start",
      "sceneaxi.project.build",
  ...
  it("never declares a project-mutating tool behind a read permission", () => {
    expect(
      ...
      { name: "sceneaxi.environment.inspect", permission: "project:read", mutatesProject: false },
      { name: "sceneaxi.environment.apply", permission: "project:write", mutatesProject: false },
      { name: "sceneaxi.material.inspect", permission: "project:read", mutatesProject: false },
      { name: "sceneaxi.material.apply", permission: "project:write", mutatesProject: false },
      { name: "sceneaxi.effect.inspect", permission: "project:read", mutatesProject: false },
      { name: "sceneaxi.effect.apply", permission: "project:write", mutatesProject: false },
      ...
      { name: "sceneaxi.workspace.layout.inspect", permission: "project:read", mutatesProject: false },
      { name: "sceneaxi.workspace.layout.apply", permission: "project:write", mutatesProject: true },
      { name: "sceneaxi.workspace.layout.reset", permission: "project:write", mutatesProject: true },
      { name: "sceneaxi.extension.inspect", permission: "project:read", mutatesProject: false },
      { name: "sceneaxi.extension.start", permission: "project:read", mutatesProject: false },
      { name: "sceneaxi.project.build", permission: "project:read", mutatesProject: false },
