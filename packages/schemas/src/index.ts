...
export {
  ...
  INPUT_ACTION_CONTEXTS,
  INPUT_ACTION_DEVICES,
  INPUT_ACTION_MAP_KIND,
  INPUT_ACTION_OVERRIDES_KIND,
  INPUT_ACTION_REFUSALS,
  INPUT_ACTION_REGISTRY,
  INPUT_ACTION_SCHEMA_VERSION,
  INPUT_ACTION_SCOPES,
...
export const contracts = Object.freeze({
  ...
  inputActionMap: "contracts/input-action-map.schema.json",
