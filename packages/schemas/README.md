...
- `contracts/delivery-handoff.schema.json` — public, portable export manifest
  for independent delivery adapters
- TypeScript: `DeliveryHandoff`, `validateDeliveryHandoff`, and
