...
| Credits + billing | `packages/billing` (append-only credit ledger, metering, free-vs-paid enforcement, default-off hosted-AI credit gate, Stripe test-mode checkout and signed-webhook grants, creator revenue share, the bounded fixture-SKU commerce path over the committed catalog) |
