...
| Credits + billing | `packages/billing` (append-only credit ledger, metering, free-vs-paid enforcement, default-off hosted-AI credit gate, Stripe test-mode checkout, signed-webhook grants and full-refund reconciliation, creator revenue share, the bounded fixture-SKU commerce path over the committed catalog) |
