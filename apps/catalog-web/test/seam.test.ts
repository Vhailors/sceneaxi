...
import { catalogSurface, seam } from "@sceneaxi/catalog-web";
...
describe("@sceneaxi/catalog-web public seam", () => {
  ...
  it("runs the shared pipeline stub without activating commerce", () => {
    const item = catalogSurface.createCatalogItemAtIntake({
      itemId: "web-fixture-asset",
      assetPackage: { packageId: "pkg-web-fixture", contentHash: HASH },
      rights: {
        license: "CC-BY-4.0",
      ...
      aiGenerationDisclosure: {
        aiGenerated: true,
        tools: ["fixture"],
        disclosureText: "Synthetic website asset fixture.",
      },
