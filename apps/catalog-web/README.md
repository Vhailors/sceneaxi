...
Dormant website-asset storefront app. Speaks **only** `@sceneaxi/schemas` catalog
contracts (Catalog Item + fail-closed pipeline stub). No storefront UI, no
marketplace activation, no spend.
