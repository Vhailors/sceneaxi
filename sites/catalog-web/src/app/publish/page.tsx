...
export default function PublishPage() {
  ...
  return (
    <>
      ...
      <p>
        Every scene in this showroom passes intake, screening, and curation with a
        recorded human verdict before it appears. That is why each detail page can show a
        complete rights and provenance record rather than a partial one.
      </p>
