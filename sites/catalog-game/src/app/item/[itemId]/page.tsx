 ...
 * Listing detail.
 *
 * Leads with the Catalog Item contract — rights, provenance, AI-generation disclosure,
 * compatibility, and pipeline state — because a game builder needs those before
 * anything else. An unknown id answers 404 through the contract's own named refusal.
 */
