...
SHA-256 (`pnpm build:sdk`, ADR 0018), never an npm publish, and it must never contain
Kids. Web editor entitlement (credits, or the unused 100-credit starter allotment; admin
unrestricted) is ADR 0019 and does not widen ADR 0003's general-E2 bound. Identity,
