...
the catalog sites consume only its injected read model. The repository ships no production
store or moderation operator; listing still requires the existing recorded
